...
const LeaderboardIcon = () => {
    return (
        ...
        {/* Ranking Icon */}
        <div className="flex items-center justify-center bg-orange-500 text-white p-2 rounded-full ring-2 ring-gray-700 shadow-lg hover:bg-orange-600 duration-300">
