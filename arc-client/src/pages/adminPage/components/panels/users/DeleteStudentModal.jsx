...
const DeleteStudentModal = ({ student, onClose, onDelete, isDarkMode }) => {
  const handleDelete = () => {
    // Call API to delete student
    console.log("Deleting student:", student._id);
    fetch(`http://localhost:5000/api/students/delete/${student._id}`, {
        method: "DELETE",
        headers: {
        ...
        .then((data) => {
          ...
          onDelete(student._id); // Call the onDelete function passed from the parent component
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="font-bold text-2xl mb-4">Delete Student</h3>
        <p className="text-lg mb-6">
          Are you sure you want to delete the student{" "}
          <span className="font-bold">{student.name}</span>? This action cannot
          be undone.
        </p>
