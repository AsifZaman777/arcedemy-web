...
const EditNoteModal = ({ noteData, onClose, isDarkMode }) => {
  ...
  // Prefill form with noteData when it changes
  useEffect(() => {
    if (noteData) {
      setUploadedFile(noteData.file || null); // Prefill with existing file if available
      setSelectedSubject(noteData.subjectName || "");
      setSelectedCurriculum(noteData.curriculum || "");
      setSelectedLevel(noteData.level || "");
      setSelectedChapter(noteData.chapterName || "");
    }
  }, [noteData]);
